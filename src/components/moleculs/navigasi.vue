...
<template>
    <nav class="navbar navbar-light  d-flex justify-between py-4 ">
        ...
        <button  class=" btn btn-link text-decoration-none bg-ungu-cerah  py-2 px-3 rounded shadow-sm"><a href="#" class="text-white text-decoration-none ">Tentang Kami</a></button>
        </div>  
    </nav>
</template>
